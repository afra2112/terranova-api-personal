...
public enum ErrorCodeEnum {
    ...
    INVALID_FACEBOOK_ACCOUNT("AUTH-012", HttpStatus.UNAUTHORIZED, "Facebook account email does not match authenticated user"),
    ...
    INVALID_VERIFICATION_CODE("AUTH-015", HttpStatus.UNAUTHORIZED, "Verification code provided is invalid."),
    VERIFICATION_CODE_EXPIRED("AUTH-016", HttpStatus.UNAUTHORIZED, "Expired verification email code"),
    EMAIL_NOT_VERIFIED("AUTH-017", HttpStatus.FORBIDDEN, "You MUST verify your email to enter the application."),
    ...
    APPOINTMENT_EXPIRED("APTM-004", HttpStatus.BAD_REQUEST, "You're trying to assist to an appointment before the present"),
    APPOINTMENT_ALREADY_RESERVED("APTM-005", HttpStatus.BAD_REQUEST, "You've already enrolled to this appointment"),
    ...
    //SENDGRID
    BREVO_RESPONSE_ERROR("SDGR-005", HttpStatus.INTERNAL_SERVER_ERROR,"Brevo api response error");
