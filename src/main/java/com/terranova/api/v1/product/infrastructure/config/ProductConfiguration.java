...
public class ProductConfiguration {
    ...
    @Bean
    public CreateImageUseCase createImageUseCase(ImageRepositoryPort imageRepositoryPort, ProductRepositoryPort productRepositoryPort){
        return new CreateImageUseCase(imageRepositoryPort, productRepositoryPort);
    }
}
